        ...
        <!-- `user_id`, `sname`, `email`, `password`, `dept`, `title`, `date`, `status` -->
                            <form action="" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" name="sname" type="text" id="fullname" placeholder="Enter your full name" required>
                                </div>
                                ...
                                <div class="mb-3 text-center">
                                    <button class="btn btn-primary" name="register_btn" type="submit"> Sign Up </button>
                                </div>
